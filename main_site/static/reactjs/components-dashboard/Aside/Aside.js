          ...
          <TabPane tabId="1">
            ...
            <div className="callout callout-warning m-0 py-1">
              <div className="avatar float-right">
                <img src={require('../../../img/avatars/7.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
              </div>
            ...
            <div className="callout callout-info m-0 py-1">
              <div className="avatar float-right">
                <img src={require('../../../img/avatars/4.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
              </div>
            ...
            <div className="callout callout-danger m-0 py-1">
              ...
              <div className="avatars-stack mt-h">
                <div className="avatar avatar-xs">
                  <img src={require('../../../img/avatars/2.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                </div>
                <div className="avatar avatar-xs">
                  <img src={require('../../../img/avatars/3.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                </div>
                <div className="avatar avatar-xs">
                  <img src={require('../../../img/avatars/4.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                </div>
                <div className="avatar avatar-xs">
                  <img src={require('../../../img/avatars/5.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com"/>
                </div>
                <div className="avatar avatar-xs">
